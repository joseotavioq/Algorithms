...
namespace AlgorithmsTest.Sorting
{
    public class InsertionSortTest
    {
        ...
        public void FirstTry_Sort_With_A_List_Totally_Unsorted()
        {
            ...
            var sortedArray = new InsertionSort().FirstTry(listOfNumbers);
        ...
        [Fact]
        public void SecondTry_Sort_With_A_List_Totally_Unsorted()
        {
            int[] listOfNumbers = new int[] { 5, 4, 6, 8, 1, 7, 3, 2 };

            var sortedArray = new InsertionSort().SecondTry(listOfNumbers);
        ...
        [Fact]
        public void ThirdTry_Sort_With_A_List_Totally_Unsorted()
        {
            int[] listOfNumbers = new int[] { 5, 4, 6, 8, 1, 7, 3, 2 };

            var sortedArray = new InsertionSort().ThirdTry(listOfNumbers);
        ...
        [Fact]
        public void ThirdTry_Sort_With_A_List_Almost_Sorted()
        {
            int[] listOfNumbers = new int[] { 1, 2, 4, 3, 5, 7, 6, 8 };
        ...
        [Fact]
        public void ThirdTry_Sort_With_A_List_In_Desc_Orders()
        {
            int[] listOfNumbers = new int[] { 8, 7, 6, 5, 4, 3, 2, 1 };
